                ...
                List<Options> options = new List<Options>()
                {
                    new Options()
                    {
                        ...
                        ClassesAndClassifiers = new List<Tuple<string, string>>()
                        {
                            ...
                            new Tuple<string, string>("property", "//( fieldName/ident/IDENTIFIER | fieldMethod/methodName/ident/IDENTIFIER )"),
                            new Tuple<string, string>("enum", "//enumDef/enumName/ident/IDENTIFIER"),
                            new Tuple<string, string>("enumMember", "//( enumValueName/ident/IDENTIFIER | enumValue/ident/IDENTIFIER | fieldConstant/ident/IDENTIFIER )"),
                            ...
                            // new Tuple<string, string>("modifier", "//"),
